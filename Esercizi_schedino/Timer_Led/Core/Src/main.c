...
{
    // Verifichiamo che l'interrupt sia stato generato proprio dal TIM2
    if (htim->Instance == TIM2)
    {
        // Qui scrivi il codice che vuoi eseguire ogni secondo
        // Esempio: facciamo lampeggiare un LED
